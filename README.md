...
pixi add geowombat geowombat-coreg geowombat-detect geowombat-dl geowombat-docs geowombat-ml geowombat-perf geowombat-sam geowombat-stac geowombat-tests geowombat-view geowombat-web geowombat-zarr
# for installing globally
pixi global install geowombat geowombat-coreg geowombat-detect geowombat-dl geowombat-docs geowombat-ml geowombat-perf geowombat-sam geowombat-stac geowombat-tests geowombat-view geowombat-web geowombat-zarr
```
...
It is possible to list all of the versions of `geowombat` available on your platform:
...
```
pixi search geowombat --channel conda-forge
```
